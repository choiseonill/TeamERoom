            ...
            <li class="nav-item active dropdown"><a
               ...
               <div class="dropdown-menu dropdown-menu-right"
                  ...
                  <a class="dropdown-item" href="blog-home-1.html">Blog Home 1</a> <a
                     ...
                     class="dropdown-item active" href="blog-post.html">Blog Post</a>
               </div></li>
            <li class="nav-item dropdown"><a
               class="nav-link dropdown-toggle" href="#" id="navbarDropdownBlog"
               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
               ...
               <div class="card-body">
                  <div class="form-group">
                     <dl>
                        ...
                        <dd>
                           <div>
                              <input type="text" name="name" value="JinhangLee"
                                 required="required">
                           </div>
                        </dd>
                     </dl>
                     <dl>
                        ...
                        <dd>
                           <div>
                              <input type="text" name="phoneNumber" value="010101010"
                                 required="required">
                           </div>
                        </dd>
                     </dl>
                     <dl>
                        ...
                        <dd>
                           <div>
                              <input type="text" name="email" value="jlee175@illinois.edu"
                                 required="required">
                           </div>
                        </dd>
                     </dl>
