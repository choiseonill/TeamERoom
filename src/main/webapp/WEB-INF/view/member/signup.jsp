...
<script type="text/javascript">
   $().ready(function() {
      ...
      var Qgreen = "<img class='questionGreenCheck' src='<c:url value='/static/img/greenCheck.PNG'/>' alt='yes' />";
      ...
      $("#question").change(function(){
    	  if($("#question").val() != null){
    		  $("#questionDiv").children(".questionRedCheck").remove();
              $("#questionDiv").append(Qgreen);
    	  }
      })
     ...
     //////////////////////회원가입 등록Btn///////////////////////////
      $("#registBtn").click(function() {
                     ...
                     if ($("#question").val() == null) {
                        $("#question").focus();
                        $("#questionDiv").children(".questionGreenCheck").remove();
...
<body>
    ...
    <div class="container" style="margin-left:60%; width:400px; display:inline-block;">
        ...
        <div>   
         ...
         <div class="rbutton" style="display:inline-block; verticl-align:top; margin-left:40%;" >   
            ...
            <div id="passConfromDiv" class="inputDiv">
               <input type="password" id="RinputPassword-confirm" class="form-control" name="password-confirm"
                     placeholder="Password-Confirm" style="display: inline-block;"/>
            </div>

            <hr>
            <div id="nameDiv" class="inputDiv">
               <input type="text" id="inputName" class="form-control" name="name"
                     placeholder="name" style="display: inline-block;" />
            </div>

            <div id="inputPhoneDiv" class="inputDiv">
               <input type="text" id="inputPhone" class="form-control"
                     name="phone" placeholder="phone" style="display: inline-block;"/>
            </div>
            <hr>
            ...
            <div id="answerDiv" class="inputDiv">
               <input type="text" id="answer" class="form-control" title="answer"
                     name="answer" placeholder="Answer" style="display: inline-block" />
            </div>
